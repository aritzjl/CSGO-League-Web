...
function publicarNoticia() {
    ...
    } else if (formData.get('contenido').length > 500) { // Validamos la longitud del contenido (no debe superar los 500 caracteres)
        errorMessage = 'El contenido no debe superar los 500 caracteres.';
    ...
    } else if (formData.get('contenido').length < 50) { // Validamos que el contenido tenga al menos 50 caracteres
