...
function enviarComentario(event) {
    ...
    var nombreUsuario = formData.get('commentUsername');
    var errorMessage = ""

    if(contenidoComentario.length < 10 || nombreUsuario.length < 3){
        errorMessage = "El comentario debe tener al menos 10 caracteres y el nombre de usuario al menos 3 caracteres.";
