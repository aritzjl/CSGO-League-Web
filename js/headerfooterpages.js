...
fetch('../Header_Footer/header.html')
    ...
    .then(html => {
        ...
        //Cambiar texto "Login" por el nombre del usuario
        fetch('../ActionsPHP/user_data.php')
            ...
            .then(data => {
                // Cambiar el texto del botón de login por el nombre del usuario
                const logintext = document.getElementById('loginText');
                logintext.textContent = data;

                //Si el usuario está loggeado, añadir la puerta para logout:
                if(data !== "LOGIN"){
